<template>
  <div class="bg-white">
    <div
      class="flex justify-between items-center px-28 py-3 sticky top-0 z-50"
      :class="{
        'bg-soft-purple bg-opacity-10': view.atTopOfPage,
    ...
    >
      <div class="flex text-left logo">
        ...
        <div>
          <span class="font-bold text-xl text-black cursor-pointer"
            >InvoiceinAja</span
          >
        </div>
      </div>
      ...
      <div>
        <a
          class="
            ...
            text-slate-900
            cursor-pointer
            hover:bg-soft-purple hover:text-white
          "
        >
          Features
        </a>
