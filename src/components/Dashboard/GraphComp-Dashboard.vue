        ...
        <div class="flex justify-between px-4 py-5">
            ...
            <div class="">
                <button
                    ...
                    class="w-44 px-3 py-2 rounded-xl shadow-invoicein flex justify-between items-center"
                >
                    {{ filterGraphName }}
                    <svg
                        class="ml-3"
                    ...
                    <div
                        :class="
                            isShowFilterChoose == true
                                ...
                                : 'max-h-0 border-none'
                        "
                        class="bg-white overflow-hidden transition-all duration-300 absolute top-3 w-48 flex flex-col rounded-xl shadow-invoicein"
                    >
                        <button
