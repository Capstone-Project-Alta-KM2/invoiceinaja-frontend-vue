    ...
    <div class="p-5 my-5 bg-white rounded-lg">
      <div class="grid grid-cols-5">
        <div class="border-2 col-span-1">
          ...
          <div class="mt-20">
            <nav class="flex flex-col items-start pr-2">
              <button
                v-ripple="'rgba(155, 109, 255, 0.2)'"
                class="flex justify-start items-center rounded-lg py-2.5 px-3 my-2 w-full border"
        ...
        <div class="border-2 col-span-4">
          <profile-setting v-if="pageActive == 'profile'" />
          <change-pass-page v-if="pageActive == 'change-pass'" />
        </div>
      </div>
    </div>
  </div>
...
<script>
import ChangePassPage from "./ChangePassPage.vue";
import ProfileSetting from "./ProfileSetting.vue";
export default {
  components: { ProfileSetting, ChangePassPage },
  name: "SettingCard",
  data() {
    return {
