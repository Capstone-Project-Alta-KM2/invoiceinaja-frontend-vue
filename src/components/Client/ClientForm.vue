...
export default {
    ...
    methods: {
        ...
        //         .then((res) => {
        //             console.log("emailchecker res :" + res);
        //         })
        //         .catch((err) => {
        //             console.log("emailchecker err :" + err);
        //         });
        // },
        ...
        //         this.clearForm();
        //     } else if (this.statusForm == "edit") {
        //         this.id = this.clientEditData.id;
        //         this.name = this.clientEditData.fullname;
        //         this.email = this.clientEditData.email;
        //         this.address = this.clientEditData.address;
        //         this.city = this.clientEditData.city;
        //         this.zipCode = this.clientEditData.zip_code;
        //         this.company = this.clientEditData.company;
        //     }
        // },
    },
    // mounted() {
    ...
    //     console.log("Props clientEditedData :");
    //     console.log(this.clientEditData);
    //     this.statusHas();
    // },
};
</script>
