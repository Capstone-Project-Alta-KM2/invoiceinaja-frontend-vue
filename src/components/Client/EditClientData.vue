                    ...
                    <div class="grid grid-cols-2 gap-x-16 gap-y-8 text-left">
                        <div class="flex flex-col">
                            ...
                            <input
                                ...
                                class="form"
                                :class="
                                    isNameEmpty ? 'border-2 border-red-500' : ''
                                "
                                v-model="name"
                                @mouseout="
                                    () => {
                        ...
                        <div class="flex flex-col">
                            ...
                            <input
                                ...
                                class="form"
                                :class="
                                    isCityEmpty ? 'border-2 border-red-500' : ''
                                "
                                v-model="city"
                                @mouseout="
                                    () => {
                        ...
                        <div class="flex flex-col">
                            ...
                            <input
                                ...
                                class="form"
                                :class="
                                    isZipEmpty ? 'border-2 border-red-500' : ''
                                "
                                v-model="zipCode"
                                @mouseout="
                                    () => {
                        ...
                        <div
                            class="flex justify-content-between col-start-2 mt-10"
                        >
                            <div>
                                <button
                                    v-ripple
...
export default {
    ...
    data() {
        return {
            ...
            name: this.editedData.fullname,
            email: this.editedData.email,
            address: this.editedData.address,
            city: this.editedData.city,
            zipCode: this.editedData.zip_code,
            company: this.editedData.company,
    ...
    methods: {
        ...
        async addClient() {
            ...
            await axios
                .put(`/api/v1/clients/${this.id}`, newData)
                .then((res) => {
                    console.log(res);
